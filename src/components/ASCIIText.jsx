...
class CanvAscii {
  ...
  async init() {
    try {
      await document.fonts.load('600 200px "NK57 Monospace"');
      await document.fonts.load('500 12px "NK57 Monospace"');
    ...
    >
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          left: 0;
          top: 0;
          background-image: radial-gradient(circle, #FFD700 0%, #4ECDC4 50%, #FF00FF 100%);
